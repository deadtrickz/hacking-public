...
| VULN             | samwell.tarly:Heartsbane             |

## Nmap Enumeration

```sh
sudo nmap -A 192.168.56.11
```
```text
PORT     STATE SERVICE           VERSION
53/tcp   open  domain            Simple DNS Plus
88/tcp   open  kerberos-sec      Microsoft Windows Kerberos (server time: 2025-08-05 14:06:06Z)
...
|_ssl-date: 2025-08-05T14:06:54+00:00; 0s from scanner time.
| ssl-cert: Subject: commonName=winterfell.north.sevenkingdoms.local
| Not valid before: 2025-06-11T15:22:42
|_Not valid after:  2025-12-11T15:22:42
...
| Not valid before: 2025-06-10T22:07:01
|_Not valid after:  2028-06-09T22:07:01
MAC Address: 00:0C:29:E2:FF:A8 (VMware)
...
| smb2-time: 
|   date: 2025-08-05T14:06:46
|_  start_date: N/A
|_nbstat: NetBIOS name: WINTERFELL, NetBIOS user: <unknown>, NetBIOS MAC: 00:0c:29:e2:ff:a8 (VMware)

TRACEROUTE
HOP RTT     ADDRESS
1   0.36 ms 192.168.56.11
```

## Automated Enumeration

##### enum4linux
- user/password discovered
	- samwell.tarly:Heartsbane

![](../../../zzAttachments/Pasted%20image%2020250805111050.png)
```
enum4linux 192.168.56.11
Starting enum4linux v0.9.1 ( http://labs.portcullis.co.uk/application/enum4linux/ ) on Tue Aug  5 12:02:18 2025
...
Domain Name: NORTH
Domain Sid: S-1-5-21-684455598-495501593-3687458957
...
index: 0x189a RID: 0x456 acb: 0x00000210 Account: arya.stark    Name: (null)    Desc: Arya Stark
index: 0x18a4 RID: 0x45b acb: 0x00010210 Account: brandon.stark Name: (null)    Desc: Brandon Stark
...
index: 0x18a9 RID: 0x45d acb: 0x00000210 Account: hodor Name: (null)    Desc: Brainless Giant
index: 0x18af RID: 0x460 acb: 0x00000210 Account: jeor.mormont  Name: (null)    Desc: Jeor Mormont
index: 0x18aa RID: 0x45e acb: 0x00040210 Account: jon.snow      Name: (null)    Desc: Jon Snow
index: 0x18a7 RID: 0x45c acb: 0x00000210 Account: rickon.stark  Name: (null)    Desc: Rickon Stark
index: 0x18ac RID: 0x45f acb: 0x00000210 Account: samwell.tarly Name: (null)    Desc: Samwell Tarly (Password : Heartsbane)
index: 0x18a3 RID: 0x45a acb: 0x00000210 Account: sansa.stark   Name: (null)    Desc: Sansa Stark
index: 0x18b1 RID: 0x461 acb: 0x00000210 Account: sql_svc       Name: (null)    Desc: sql service
...
enum4linux complete on Tue Aug  5 12:02:24 2025
```
