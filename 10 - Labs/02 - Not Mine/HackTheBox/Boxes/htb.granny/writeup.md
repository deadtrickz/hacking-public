...
![writeup.overview.machinescli](Box%20Write-ups/htb.granny/machinescli.png)

### Killchain
Here's the killchain (`enumeration` → `exploitation` → `privilege escalation`) for this machine:

![writeup.overview.killchain](Box%20Write-ups/htb.granny/killchain.png)
...
![writeup.enumeration.steps.2.1](Box%20Write-ups/htb.granny/openports.png)  

3\. We look for IIS 6.0 vulnerabilities and find multiple WebDAV related hits:  

![writeup.enumeration.steps.3.1](Box%20Write-ups/htb.granny/screenshot01.png)  
...
![writeup.exploitation.steps.1.1](Box%20Write-ups/htb.granny/screenshot02.png)  

![writeup.exploitation.steps.1.2](Box%20Write-ups/htb.granny/screenshot03.png)  
...
![writeup.privesc.steps.1.1](Box%20Write-ups/htb.granny/screenshot04.png)  

2\. We can now use the Metasploit `multi/recon/local_exploit_suggester` module to look for privesc options:  

![writeup.privesc.steps.2.1](Box%20Write-ups/htb.granny/screenshot05.png)  
...
![writeup.privesc.steps.3.1](Box%20Write-ups/htb.granny/screenshot06.png)  

![writeup.privesc.steps.3.2](Box%20Write-ups/htb.granny/screenshot07.png)  
...
![writeup.privesc.steps.4.1](Box%20Write-ups/htb.granny/screenshot08.png)  
