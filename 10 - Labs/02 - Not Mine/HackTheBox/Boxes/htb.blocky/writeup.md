...
![writeup.overview.machinescli](Box%20Write-ups/htb.blocky/machinescli.png)

### Killchain
Here's the killchain (`enumeration` → `exploitation` → `privilege escalation`) for this machine:

![writeup.overview.killchain](Box%20Write-ups/htb.blocky/killchain.png)
...
![writeup.enumeration.steps.2.1](Box%20Write-ups/htb.blocky/openports.png)  
...
![writeup.enumeration.steps.3.1](Box%20Write-ups/htb.blocky/screenshot01.png)  
...
![writeup.enumeration.steps.4.1](Box%20Write-ups/htb.blocky/screenshot02.png)  

![writeup.enumeration.steps.4.2](Box%20Write-ups/htb.blocky/screenshot03.png)  
...
![writeup.exploitation.steps.1.1](Box%20Write-ups/htb.blocky/screenshot04.png)  
...
![writeup.exploitation.steps.2.1](Box%20Write-ups/htb.blocky/screenshot05.png)  

![writeup.exploitation.steps.2.2](Box%20Write-ups/htb.blocky/screenshot06.png)  
...
![writeup.privesc.steps.1.1](Box%20Write-ups/htb.blocky/screenshot07.png)  

![writeup.privesc.steps.1.2](Box%20Write-ups/htb.blocky/screenshot08.png)  

2\. We then read the contents of `root.txt` file to complete the challenge:  

![writeup.privesc.steps.2.1](Box%20Write-ups/htb.blocky/screenshot09.png)  
