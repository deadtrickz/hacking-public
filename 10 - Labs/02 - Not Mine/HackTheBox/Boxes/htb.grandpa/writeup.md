...
![writeup.overview.machinescli](Box%20Write-ups/htb.grandpa/machinescli.png)

### Killchain
Here's the killchain (`enumeration` → `exploitation` → `privilege escalation`) for this machine:

![writeup.overview.killchain](Box%20Write-ups/htb.grandpa/killchain.png)
...
![writeup.enumeration.steps.2.1](Box%20Write-ups/htb.grandpa/openports.png)  

3\. We look for IIS 6.0 vulnerabilities and find multiple WebDAV related hits:  

![writeup.enumeration.steps.3.1](Box%20Write-ups/htb.grandpa/screenshot01.png)  
...
![writeup.exploitation.steps.1.1](Box%20Write-ups/htb.grandpa/screenshot02.png)  

![writeup.exploitation.steps.1.2](Box%20Write-ups/htb.grandpa/screenshot03.png)  
...
![writeup.privesc.steps.1.1](Box%20Write-ups/htb.grandpa/screenshot04.png)  

2\. We can now use the Metasploit `multi/recon/local_exploit_suggester` module to look for privesc options:  

![writeup.privesc.steps.2.1](Box%20Write-ups/htb.grandpa/screenshot05.png)  
...
![writeup.privesc.steps.3.1](Box%20Write-ups/htb.grandpa/screenshot06.png)  

![writeup.privesc.steps.3.2](Box%20Write-ups/htb.grandpa/screenshot07.png)  
...
![writeup.privesc.steps.4.1](Box%20Write-ups/htb.grandpa/screenshot08.png)  
