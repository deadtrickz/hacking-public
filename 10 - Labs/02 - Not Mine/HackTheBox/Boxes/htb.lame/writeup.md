...
![writeup.overview.machinescli](Box%20Write-ups/htb.lame/machinescli.png)

### Killchain
Here's the killchain (`enumeration` → `exploitation` → `privilege escalation`) for this machine:

![writeup.overview.killchain](Box%20Write-ups/htb.lame/killchain.png)
...
![writeup.enumeration.steps.2.1](Box%20Write-ups/htb.lame/openports.png)  
...
![writeup.enumeration.steps.3.1](Box%20Write-ups/htb.lame/screenshot01.png)  

![writeup.enumeration.steps.3.2](Box%20Write-ups/htb.lame/screenshot02.png)  
...
![writeup.enumeration.steps.4.1](Box%20Write-ups/htb.lame/screenshot03.png)  
...
![writeup.exploitation.steps.1.1](Box%20Write-ups/htb.lame/screenshot04.png)  

![writeup.exploitation.steps.1.2](Box%20Write-ups/htb.lame/screenshot05.png)  
...
![writeup.exploitation.steps.2.1](Box%20Write-ups/htb.lame/screenshot06.png)  
