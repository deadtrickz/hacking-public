...
![writeup.overview.machinescli](Box%20Write-ups/htb.blue/machinescli.png)

### Killchain
Here's the killchain (`enumeration` → `exploitation` → `privilege escalation`) for this machine:

![writeup.overview.killchain](Box%20Write-ups/htb.blue/killchain.png)
...
![writeup.enumeration.steps.2.1](Box%20Write-ups/htb.blue/openports.png)  
...
![writeup.enumeration.steps.3.1](Box%20Write-ups/htb.blue/screenshot01.png)  
...
![writeup.enumeration.steps.5.1](Box%20Write-ups/htb.blue/screenshot02.png)  
...
![writeup.enumeration.steps.6.1](Box%20Write-ups/htb.blue/screenshot03.png)  
...
![writeup.exploitation.steps.1.1](Box%20Write-ups/htb.blue/screenshot04.png)  

![writeup.exploitation.steps.1.2](Box%20Write-ups/htb.blue/screenshot05.png)  

![writeup.exploitation.steps.1.3](Box%20Write-ups/htb.blue/screenshot06.png)  

![writeup.exploitation.steps.1.4](Box%20Write-ups/htb.blue/screenshot07.png)  

![writeup.exploitation.steps.1.5](Box%20Write-ups/htb.blue/screenshot08.png)  
...
![writeup.exploitation.steps.2.1](Box%20Write-ups/htb.blue/screenshot09.png)  

![writeup.exploitation.steps.2.2](Box%20Write-ups/htb.blue/screenshot10.png)  

![writeup.exploitation.steps.2.3](Box%20Write-ups/htb.blue/screenshot11.png)  
