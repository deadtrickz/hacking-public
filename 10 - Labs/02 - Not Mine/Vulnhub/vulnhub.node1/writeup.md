...
![writeup.overview.machinescli](Box%20Write-ups/vulnhub.node1/machinescli.png)

### Killchain
Here's the killchain (`enumeration` → `exploitation` → `privilege escalation`) for this machine:

![writeup.overview.killchain](Box%20Write-ups/vulnhub.node1/killchain.png)
...
![writeup.enumeration.steps.2.1](Box%20Write-ups/vulnhub.node1/openports.png)  
...
![writeup.enumeration.steps.3.1](Box%20Write-ups/vulnhub.node1/screenshot01.png)  

![writeup.enumeration.steps.3.2](Box%20Write-ups/vulnhub.node1/screenshot02.png)  

![writeup.enumeration.steps.3.3](Box%20Write-ups/vulnhub.node1/screenshot03.png)  
...
![writeup.exploitation.steps.1.1](Box%20Write-ups/vulnhub.node1/screenshot04.png)  

![writeup.exploitation.steps.1.2](Box%20Write-ups/vulnhub.node1/screenshot06.png)  

![writeup.exploitation.steps.1.3](Box%20Write-ups/vulnhub.node1/screenshot07.png)  

![writeup.exploitation.steps.1.4](Box%20Write-ups/vulnhub.node1/screenshot08.png)  
...
![writeup.exploitation.steps.2.1](Box%20Write-ups/vulnhub.node1/screenshot09.png)  

![writeup.exploitation.steps.2.2](Box%20Write-ups/vulnhub.node1/screenshot10.png)  
...
![writeup.exploitation.steps.3.1](Box%20Write-ups/vulnhub.node1/screenshot11.png)  

![writeup.exploitation.steps.3.2](Box%20Write-ups/vulnhub.node1/screenshot12.png)  
...
![writeup.exploitation.steps.4.1](Box%20Write-ups/vulnhub.node1/screenshot13.png)  

![writeup.exploitation.steps.4.2](Box%20Write-ups/vulnhub.node1/screenshot14.png)  

![writeup.exploitation.steps.4.3](Box%20Write-ups/vulnhub.node1/screenshot15.png)  

![writeup.exploitation.steps.4.4](Box%20Write-ups/vulnhub.node1/screenshot16.png)  
...
![writeup.privesc.steps.1.1](Box%20Write-ups/vulnhub.node1/screenshot17.png)  

![writeup.privesc.steps.1.2](Box%20Write-ups/vulnhub.node1/screenshot18.png)  

![writeup.privesc.steps.1.3](Box%20Write-ups/vulnhub.node1/screenshot19.png)  

![writeup.privesc.steps.1.4](Box%20Write-ups/vulnhub.node1/screenshot20.png)  

![writeup.privesc.steps.1.5](Box%20Write-ups/vulnhub.node1/screenshot21.png)  
...
![writeup.privesc.steps.2.1](Box%20Write-ups/vulnhub.node1/screenshot22.png)  
