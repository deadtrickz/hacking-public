...
![writeup.overview.machinescli](Box%20Write-ups/vulnhub.kioptrix3/machinescli.png)

### Killchain
Here's the killchain (`enumeration` → `exploitation` → `privilege escalation`) for this machine:

![writeup.overview.killchain](Box%20Write-ups/vulnhub.kioptrix3/killchain.png)
...
![writeup.enumeration.steps.2.1](Box%20Write-ups/vulnhub.kioptrix3/openports.png)  
...
![writeup.enumeration.steps.3.1](Box%20Write-ups/vulnhub.kioptrix3/screenshot00.png)  

4\. We find a login page at the following url: `http://kioptrix3.com/index.php?system=Admin`  

![writeup.enumeration.steps.4.1](Box%20Write-ups/vulnhub.kioptrix3/screenshot01.png)  
...
![writeup.enumeration.steps.5.1](Box%20Write-ups/vulnhub.kioptrix3/screenshot02.png)  
...
![writeup.enumeration.steps.6.1](Box%20Write-ups/vulnhub.kioptrix3/screenshot03.png)  

![writeup.enumeration.steps.6.2](Box%20Write-ups/vulnhub.kioptrix3/screenshot04.png)  
...
![writeup.exploitation.steps.1.1](Box%20Write-ups/vulnhub.kioptrix3/screenshot05a.png)  

![writeup.exploitation.steps.1.2](Box%20Write-ups/vulnhub.kioptrix3/screenshot05b.png)  
...
![writeup.exploitation.steps.2.1](Box%20Write-ups/vulnhub.kioptrix3/screenshot06.png)  
...
![writeup.privesc.steps.1.1](Box%20Write-ups/vulnhub.kioptrix3/screenshot07.png)  
...
![writeup.privesc.steps.2.1](Box%20Write-ups/vulnhub.kioptrix3/screenshot08.png)  
...
![writeup.privesc.steps.3.1](Box%20Write-ups/vulnhub.kioptrix3/screenshot09.png)  

![writeup.privesc.steps.3.2](Box%20Write-ups/vulnhub.kioptrix3/screenshot10.png)  
