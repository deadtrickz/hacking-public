...
![writeup.overview.machinescli](Box%20Write-ups/vulnhub.lordoftheroot101/machinescli.png)

### Killchain
Here's the killchain (`enumeration` → `exploitation` → `privilege escalation`) for this machine:

![writeup.overview.killchain](Box%20Write-ups/vulnhub.lordoftheroot101/killchain.png)
...
![writeup.enumeration.steps.2.1](Box%20Write-ups/vulnhub.lordoftheroot101/openports.png)  
...
![writeup.enumeration.steps.3.1](Box%20Write-ups/vulnhub.lordoftheroot101/screenshot01.png)  

![writeup.enumeration.steps.3.2](Box%20Write-ups/vulnhub.lordoftheroot101/screenshot02.png)  

![writeup.enumeration.steps.3.3](Box%20Write-ups/vulnhub.lordoftheroot101/screenshot03.png)  
...
![writeup.enumeration.steps.4.1](Box%20Write-ups/vulnhub.lordoftheroot101/screenshot04.png)  

![writeup.enumeration.steps.4.2](Box%20Write-ups/vulnhub.lordoftheroot101/screenshot05.png)  

![writeup.enumeration.steps.4.3](Box%20Write-ups/vulnhub.lordoftheroot101/screenshot06.png)  
...
![writeup.exploitation.steps.1.1](Box%20Write-ups/vulnhub.lordoftheroot101/screenshot07.png)  

![writeup.exploitation.steps.1.2](Box%20Write-ups/vulnhub.lordoftheroot101/screenshot08.png)  
...
![writeup.exploitation.steps.2.1](Box%20Write-ups/vulnhub.lordoftheroot101/screenshot09.png)  

![writeup.exploitation.steps.2.2](Box%20Write-ups/vulnhub.lordoftheroot101/screenshot10.png)  
...
![writeup.privesc.steps.1.1](Box%20Write-ups/vulnhub.lordoftheroot101/screenshot11.png)  
...
![writeup.privesc.steps.2.1](Box%20Write-ups/vulnhub.lordoftheroot101/screenshot12.png)  
...
![writeup.privesc.steps.3.1](Box%20Write-ups/vulnhub.lordoftheroot101/screenshot16.png)  

![writeup.privesc.steps.3.2](Box%20Write-ups/vulnhub.lordoftheroot101/screenshot17.png)  

![writeup.privesc.steps.3.3](Box%20Write-ups/vulnhub.lordoftheroot101/screenshot18.png)  

![writeup.privesc.steps.3.4](Box%20Write-ups/vulnhub.lordoftheroot101/screenshot19.png)  
...
![writeup.privesc.steps.4.1](Box%20Write-ups/vulnhub.lordoftheroot101/screenshot20.png)  
...
![writeup.privesc.steps.5.1](Box%20Write-ups/vulnhub.lordoftheroot101/screenshot13.png)  

![writeup.privesc.steps.5.2](Box%20Write-ups/vulnhub.lordoftheroot101/screenshot14.png)  
...
![writeup.privesc.steps.6.1](Box%20Write-ups/vulnhub.lordoftheroot101/screenshot15.png)  
