...
![writeup.overview.machinescli](Box%20Write-ups/vulnhub.fristileaks1dot3/machinescli.png)

### Killchain
Here's the killchain (`enumeration` → `exploitation` → `privilege escalation`) for this machine:

![writeup.overview.killchain](Box%20Write-ups/vulnhub.fristileaks1dot3/killchain.png)
...
![writeup.enumeration.steps.2.1](Box%20Write-ups/vulnhub.fristileaks1dot3/openports.png)  
...
![writeup.enumeration.steps.3.1](Box%20Write-ups/vulnhub.fristileaks1dot3/screenshot01.png)  
...
![writeup.enumeration.steps.4.1](Box%20Write-ups/vulnhub.fristileaks1dot3/screenshot02.png)  
...
![writeup.exploitation.steps.1.1](Box%20Write-ups/vulnhub.fristileaks1dot3/screenshot02a.png)  

![writeup.exploitation.steps.1.2](Box%20Write-ups/vulnhub.fristileaks1dot3/screenshot02b.png)  
...
![writeup.exploitation.steps.2.1](Box%20Write-ups/vulnhub.fristileaks1dot3/screenshot03.png)  
...
![writeup.exploitation.steps.3.1](Box%20Write-ups/vulnhub.fristileaks1dot3/screenshot04.png)  

![writeup.exploitation.steps.3.2](Box%20Write-ups/vulnhub.fristileaks1dot3/screenshot05.png)  
...
![writeup.privesc.steps.1.1](Box%20Write-ups/vulnhub.fristileaks1dot3/screenshot06.png)  
...
![writeup.privesc.steps.2.1](Box%20Write-ups/vulnhub.fristileaks1dot3/screenshot07.png)  
...
![writeup.privesc.steps.3.1](Box%20Write-ups/vulnhub.fristileaks1dot3/screenshot07a.png)  
...
![writeup.privesc.steps.4.1](Box%20Write-ups/vulnhub.fristileaks1dot3/screenshot07b.png)  

![writeup.privesc.steps.4.2](Box%20Write-ups/vulnhub.fristileaks1dot3/screenshot07c.png)  
...
![writeup.privesc.steps.5.1](Box%20Write-ups/vulnhub.fristileaks1dot3/screenshot07d.png)  

![writeup.privesc.steps.5.2](Box%20Write-ups/vulnhub.fristileaks1dot3/screenshot07e.png)  
...
![writeup.privesc.steps.6.1](Box%20Write-ups/vulnhub.fristileaks1dot3/screenshot07f.png)  

![writeup.privesc.steps.6.2](Box%20Write-ups/vulnhub.fristileaks1dot3/screenshot07g.png)  
...
![writeup.privesc.steps.7.1](Box%20Write-ups/vulnhub.fristileaks1dot3/screenshot08.png)  
...
![writeup.privesc.steps.8.1](Box%20Write-ups/vulnhub.fristileaks1dot3/screenshot09.png)  
