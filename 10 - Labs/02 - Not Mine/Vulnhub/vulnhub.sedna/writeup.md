...
![writeup.overview.machinescli](Box%20Write-ups/vulnhub.sedna/machinescli.png)

### Killchain
Here's the killchain (`enumeration` → `exploitation` → `privilege escalation`) for this machine:

![writeup.overview.killchain](Box%20Write-ups/vulnhub.sedna/killchain.png)
...
![writeup.enumeration.steps.2.1](Box%20Write-ups/vulnhub.sedna/openports.png)  
...
![writeup.exploitation.steps.1.1](Box%20Write-ups/vulnhub.sedna/screenshot02a.png)  
...
![writeup.exploitation.steps.2.1](Box%20Write-ups/vulnhub.sedna/screenshot01.png)  

![writeup.exploitation.steps.2.2](Box%20Write-ups/vulnhub.sedna/screenshot03.png)  

![writeup.exploitation.steps.2.3](Box%20Write-ups/vulnhub.sedna/screenshot04.png)  
...
![writeup.privesc.steps.1.1](Box%20Write-ups/vulnhub.sedna/screenshot05.png)  
...
![writeup.privesc.steps.2.1](Box%20Write-ups/vulnhub.sedna/screenshot05a.png)  
...
![writeup.privesc.steps.3.1](Box%20Write-ups/vulnhub.sedna/screenshot05b.png)  

![writeup.privesc.steps.3.2](Box%20Write-ups/vulnhub.sedna/screenshot05c.png)  
...
![writeup.privesc.steps.4.1](Box%20Write-ups/vulnhub.sedna/screenshot05d.png)  
...
![writeup.privesc.steps.5.1](Box%20Write-ups/vulnhub.sedna/screenshot06.png)  
...
![writeup.privesc.steps.6.1](Box%20Write-ups/vulnhub.sedna/screenshot07.png)  
...
![writeup.privesc.steps.7.1](Box%20Write-ups/vulnhub.sedna/screenshot08.png)  
...
![writeup.privesc.steps.8.1](Box%20Write-ups/vulnhub.sedna/screenshot09.png)  

![writeup.privesc.steps.8.2](Box%20Write-ups/vulnhub.sedna/screenshot10.png)  
