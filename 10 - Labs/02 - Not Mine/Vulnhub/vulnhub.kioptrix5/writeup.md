...
![writeup.overview.machinescli](Box%20Write-ups/vulnhub.kioptrix5/machinescli.png)

### Killchain
Here's the killchain (`enumeration` → `exploitation` → `privilege escalation`) for this machine:

![writeup.overview.killchain](Box%20Write-ups/vulnhub.kioptrix5/killchain.png)
...
![writeup.enumeration.steps.2.1](Box%20Write-ups/vulnhub.kioptrix5/openports.png)  

3\. While exploring the `80/tcp` service, we find a HTML comment that points to `pChart2.1.3/index.php`:  

![writeup.enumeration.steps.3.1](Box%20Write-ups/vulnhub.kioptrix5/screenshot01.png)  

![writeup.enumeration.steps.3.2](Box%20Write-ups/vulnhub.kioptrix5/screenshot02.png)  

![writeup.enumeration.steps.3.3](Box%20Write-ups/vulnhub.kioptrix5/screenshot03.png)  
...
![writeup.exploitation.steps.1.1](Box%20Write-ups/vulnhub.kioptrix5/screenshot04.png)  

![writeup.exploitation.steps.1.2](Box%20Write-ups/vulnhub.kioptrix5/screenshot05.png)  

![writeup.exploitation.steps.1.3](Box%20Write-ups/vulnhub.kioptrix5/screenshot06.png)  
...
![writeup.exploitation.steps.2.1](Box%20Write-ups/vulnhub.kioptrix5/screenshot07.png)  
...
![writeup.exploitation.steps.3.1](Box%20Write-ups/vulnhub.kioptrix5/screenshot08.png)  
...
![writeup.exploitation.steps.4.1](Box%20Write-ups/vulnhub.kioptrix5/screenshot09.png)  

![writeup.exploitation.steps.4.2](Box%20Write-ups/vulnhub.kioptrix5/screenshot10.png)  

![writeup.exploitation.steps.4.3](Box%20Write-ups/vulnhub.kioptrix5/screenshot11.png)  

![writeup.exploitation.steps.4.4](Box%20Write-ups/vulnhub.kioptrix5/screenshot12.png)  
...
![writeup.exploitation.steps.5.1](Box%20Write-ups/vulnhub.kioptrix5/screenshot13.png)  

![writeup.exploitation.steps.5.2](Box%20Write-ups/vulnhub.kioptrix5/screenshot14.png)  
...
![writeup.privesc.steps.1.1](Box%20Write-ups/vulnhub.kioptrix5/screenshot15.png)  

![writeup.privesc.steps.1.2](Box%20Write-ups/vulnhub.kioptrix5/screenshot16.png)  

![writeup.privesc.steps.1.3](Box%20Write-ups/vulnhub.kioptrix5/screenshot17.png)  

![writeup.privesc.steps.1.4](Box%20Write-ups/vulnhub.kioptrix5/screenshot18.png)  

![writeup.privesc.steps.1.5](Box%20Write-ups/vulnhub.kioptrix5/screenshot19.png)  
...
![writeup.privesc.steps.2.1](Box%20Write-ups/vulnhub.kioptrix5/screenshot20.png)  
