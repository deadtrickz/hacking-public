...
![writeup.overview.machinescli](Box%20Write-ups/vulnhub.vulnix/machinescli.png)

### Killchain
Here's the killchain (`enumeration` → `exploitation` → `privilege escalation`) for this machine:

![writeup.overview.killchain](Box%20Write-ups/vulnhub.vulnix/killchain.png)
...
![writeup.enumeration.steps.2.1](Box%20Write-ups/vulnhub.vulnix/openports.png)  
...
![writeup.enumeration.steps.5.1](Box%20Write-ups/vulnhub.vulnix/screenshot01.png)  
...
![writeup.exploitation.steps.2.1](Box%20Write-ups/vulnhub.vulnix/screenshot03.png)  

![writeup.exploitation.steps.2.2](Box%20Write-ups/vulnhub.vulnix/screenshot04.png)  

![writeup.exploitation.steps.2.3](Box%20Write-ups/vulnhub.vulnix/screenshot05.png)  
...
![writeup.privesc.steps.1.1](Box%20Write-ups/vulnhub.vulnix/screenshot06.png)  
...
![writeup.privesc.steps.2.1](Box%20Write-ups/vulnhub.vulnix/screenshot07.png)  
...
![writeup.privesc.steps.3.1](Box%20Write-ups/vulnhub.vulnix/screenshot08.png)  
...
![writeup.privesc.steps.4.1](Box%20Write-ups/vulnhub.vulnix/screenshot09.png)  

![writeup.privesc.steps.4.2](Box%20Write-ups/vulnhub.vulnix/screenshot10.png)  

![writeup.privesc.steps.4.3](Box%20Write-ups/vulnhub.vulnix/screenshot11.png)  
...
![writeup.privesc.steps.5.1](Box%20Write-ups/vulnhub.vulnix/screenshot12.png)  
