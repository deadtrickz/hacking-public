...
![writeup.overview.machinescli](Box%20Write-ups/vulnhub.kioptrix4/machinescli.png)

### Killchain
Here's the killchain (`enumeration` → `exploitation` → `privilege escalation`) for this machine:

![writeup.overview.killchain](Box%20Write-ups/vulnhub.kioptrix4/killchain.png)
...
![writeup.enumeration.steps.2.1](Box%20Write-ups/vulnhub.kioptrix4/openports.png)  
...
![writeup.exploitation.steps.1.1](Box%20Write-ups/vulnhub.kioptrix4/screenshot01.png)  

![writeup.exploitation.steps.1.2](Box%20Write-ups/vulnhub.kioptrix4/screenshot02.png)  

![writeup.exploitation.steps.1.3](Box%20Write-ups/vulnhub.kioptrix4/screenshot03.png)  
...
![writeup.exploitation.steps.2.1](Box%20Write-ups/vulnhub.kioptrix4/screenshot04.png)  
...
![writeup.exploitation.steps.3.1](Box%20Write-ups/vulnhub.kioptrix4/screenshot05.png)  
...
![writeup.privesc.steps.1.1](Box%20Write-ups/vulnhub.kioptrix4/screenshot06.png)  
...
![writeup.privesc.steps.2.1](Box%20Write-ups/vulnhub.kioptrix4/screenshot07.png)  
...
![writeup.privesc.steps.3.1](Box%20Write-ups/vulnhub.kioptrix4/screenshot08.png)  
...
![writeup.privesc.steps.4.1](Box%20Write-ups/vulnhub.kioptrix4/screenshot09.png)  

![writeup.privesc.steps.4.2](Box%20Write-ups/vulnhub.kioptrix4/screenshot10.png)  
