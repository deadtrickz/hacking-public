...
![writeup.overview.machinescli](Box%20Write-ups/vulnhub.kioptrix2/machinescli.png)

### Killchain
Here's the killchain (`enumeration` → `exploitation` → `privilege escalation`) for this machine:

![writeup.overview.killchain](Box%20Write-ups/vulnhub.kioptrix2/killchain.png)
...
![writeup.enumeration.steps.2.1](Box%20Write-ups/vulnhub.kioptrix2/openports.png)  
...
![writeup.enumeration.steps.3.1](Box%20Write-ups/vulnhub.kioptrix2/screenshot01.png)  

![writeup.enumeration.steps.3.2](Box%20Write-ups/vulnhub.kioptrix2/screenshot02.png)  
...
![writeup.enumeration.steps.4.1](Box%20Write-ups/vulnhub.kioptrix2/screenshot03.png)  

![writeup.enumeration.steps.4.2](Box%20Write-ups/vulnhub.kioptrix2/screenshot04.png)  
...
![writeup.exploitation.steps.1.1](Box%20Write-ups/vulnhub.kioptrix2/screenshot05.png)  

![writeup.exploitation.steps.1.2](Box%20Write-ups/vulnhub.kioptrix2/screenshot06.png)  
...
![writeup.exploitation.steps.2.1](Box%20Write-ups/vulnhub.kioptrix2/screenshot07.png)  

![writeup.exploitation.steps.2.2](Box%20Write-ups/vulnhub.kioptrix2/screenshot08.png)  
...
![writeup.exploitation.steps.3.1](Box%20Write-ups/vulnhub.kioptrix2/screenshot09.png)  

![writeup.exploitation.steps.3.2](Box%20Write-ups/vulnhub.kioptrix2/screenshot10.png)  

![writeup.exploitation.steps.3.3](Box%20Write-ups/vulnhub.kioptrix2/screenshot11.png)  
...
![writeup.privesc.steps.1.1](Box%20Write-ups/vulnhub.kioptrix2/screenshot12.png)  
...
![writeup.privesc.steps.2.1](Box%20Write-ups/vulnhub.kioptrix2/screenshot13.png)  

![writeup.privesc.steps.2.2](Box%20Write-ups/vulnhub.kioptrix2/screenshot14.png)  
...
![writeup.privesc.steps.3.1](Box%20Write-ups/vulnhub.kioptrix2/screenshot15.png)  
...
![writeup.privesc.steps.5.1](Box%20Write-ups/vulnhub.kioptrix2/screenshot16.png)  

![writeup.privesc.steps.5.2](Box%20Write-ups/vulnhub.kioptrix2/screenshot17.png)  

![writeup.privesc.steps.5.3](Box%20Write-ups/vulnhub.kioptrix2/screenshot18.png)  
