...
![writeup.overview.machinescli](Box%20Write-ups/vulnhub.quaoar/machinescli.png)

### Killchain
Here's the killchain (`enumeration` → `exploitation` → `privilege escalation`) for this machine:

![writeup.overview.killchain](Box%20Write-ups/vulnhub.quaoar/killchain.png)
...
![writeup.enumeration.steps.2.1](Box%20Write-ups/vulnhub.quaoar/openports.png)  
...
![writeup.enumeration.steps.3.1](Box%20Write-ups/vulnhub.quaoar/screenshot01.png)  
...
![writeup.enumeration.steps.4.1](Box%20Write-ups/vulnhub.quaoar/screenshot02.png)  
...
![writeup.exploitation.steps.1.1](Box%20Write-ups/vulnhub.quaoar/screenshot03.png)  
...
![writeup.exploitation.steps.2.1](Box%20Write-ups/vulnhub.quaoar/screenshot05.png)  

![writeup.exploitation.steps.2.2](Box%20Write-ups/vulnhub.quaoar/screenshot04.png)  
...
![writeup.privesc.steps.1.1](Box%20Write-ups/vulnhub.quaoar/screenshot06.png)  
...
![writeup.privesc.steps.2.1](Box%20Write-ups/vulnhub.quaoar/screenshot08.png)  
...
![writeup.privesc.steps.3.1](Box%20Write-ups/vulnhub.quaoar/screenshot07.png)  
...
![writeup.privesc.steps.4.1](Box%20Write-ups/vulnhub.quaoar/screenshot10.png)  
