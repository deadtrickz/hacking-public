...
![writeup.overview.machinescli](Box%20Write-ups/vulnhub.misdirection1/machinescli.png)

### Killchain
Here's the killchain (`enumeration` → `exploitation` → `privilege escalation`) for this machine:

![writeup.overview.killchain](Box%20Write-ups/vulnhub.misdirection1/killchain.png)
...
![writeup.enumeration.steps.2.1](Box%20Write-ups/vulnhub.misdirection1/openports.png)  
...
![writeup.enumeration.steps.4.1](Box%20Write-ups/vulnhub.misdirection1/screenshot00.png)  
...
![writeup.exploitation.steps.1.1](Box%20Write-ups/vulnhub.misdirection1/screenshot01.png)  

![writeup.exploitation.steps.1.2](Box%20Write-ups/vulnhub.misdirection1/screenshot02.png)  
...
![writeup.privesc.steps.1.1](Box%20Write-ups/vulnhub.misdirection1/screenshot03.png)  

![writeup.privesc.steps.1.2](Box%20Write-ups/vulnhub.misdirection1/screenshot04.png)  

![writeup.privesc.steps.1.3](Box%20Write-ups/vulnhub.misdirection1/screenshot05.png)  

![writeup.privesc.steps.1.4](Box%20Write-ups/vulnhub.misdirection1/screenshot06.png)  

![writeup.privesc.steps.1.5](Box%20Write-ups/vulnhub.misdirection1/screenshot07.png)  

![writeup.privesc.steps.1.6](Box%20Write-ups/vulnhub.misdirection1/screenshot08.png)  

![writeup.privesc.steps.1.7](Box%20Write-ups/vulnhub.misdirection1/screenshot09.png)  
...
![writeup.privesc.steps.2.1](Box%20Write-ups/vulnhub.misdirection1/screenshot10.png)  
