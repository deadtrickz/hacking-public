...
![writeup.overview.machinescli](Box%20Write-ups/vulnhub.kioptrix1/machinescli.png)

### Killchain
Here's the killchain (`enumeration` → `exploitation` → `privilege escalation`) for this machine:

![writeup.overview.killchain](Box%20Write-ups/vulnhub.kioptrix1/killchain.png)
...
![writeup.enumeration.steps.2.1](Box%20Write-ups/vulnhub.kioptrix1/openports.png)  
...
![writeup.enumeration.steps.4.1](Box%20Write-ups/vulnhub.kioptrix1/screenshot01.png)  
...
![writeup.exploitation.steps.1.1](Box%20Write-ups/vulnhub.kioptrix1/screenshot02.png)  

![writeup.exploitation.steps.1.2](Box%20Write-ups/vulnhub.kioptrix1/screenshot03.png)  

![writeup.exploitation.steps.1.3](Box%20Write-ups/vulnhub.kioptrix1/screenshot04.png)  
...
![writeup.exploitation.steps.2.1](Box%20Write-ups/vulnhub.kioptrix1/screenshot05.png)  
