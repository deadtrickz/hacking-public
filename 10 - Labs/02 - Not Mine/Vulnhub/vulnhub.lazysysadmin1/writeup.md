...
![writeup.overview.machinescli](Box%20Write-ups/vulnhub.lazysysadmin1/machinescli.png)

### Killchain
Here's the killchain (`enumeration` → `exploitation` → `privilege escalation`) for this machine:

![writeup.overview.killchain](Box%20Write-ups/vulnhub.lazysysadmin1/killchain.png)
...
![writeup.enumeration.steps.2.1](Box%20Write-ups/vulnhub.lazysysadmin1/openports.png)  
...
![writeup.enumeration.steps.3.1](Box%20Write-ups/vulnhub.lazysysadmin1/screenshot01.png)  

![writeup.enumeration.steps.3.2](Box%20Write-ups/vulnhub.lazysysadmin1/screenshot02.png)  
...
![writeup.enumeration.steps.4.1](Box%20Write-ups/vulnhub.lazysysadmin1/screenshot07.png)  

![writeup.enumeration.steps.4.2](Box%20Write-ups/vulnhub.lazysysadmin1/screenshot08.png)  
...
![writeup.enumeration.steps.5.1](Box%20Write-ups/vulnhub.lazysysadmin1/screenshot03.png)  

![writeup.enumeration.steps.5.2](Box%20Write-ups/vulnhub.lazysysadmin1/screenshot03a.png)  

![writeup.enumeration.steps.5.3](Box%20Write-ups/vulnhub.lazysysadmin1/screenshot04.png)  
...
![writeup.exploitation.steps.1.1](Box%20Write-ups/vulnhub.lazysysadmin1/screenshot04a.png)  
...
![writeup.exploitation.steps.2.1](Box%20Write-ups/vulnhub.lazysysadmin1/screenshot09.png)  
...
![writeup.exploitation.steps.3.1](Box%20Write-ups/vulnhub.lazysysadmin1/screenshot10.png)  

![writeup.exploitation.steps.3.2](Box%20Write-ups/vulnhub.lazysysadmin1/screenshot12.png)  
...
![writeup.privesc.steps.1.1](Box%20Write-ups/vulnhub.lazysysadmin1/screenshot15.png)  

![writeup.privesc.steps.1.2](Box%20Write-ups/vulnhub.lazysysadmin1/screenshot16.png)  
...
![writeup.privesc.steps.2.1](Box%20Write-ups/vulnhub.lazysysadmin1/screenshot17.png)  
