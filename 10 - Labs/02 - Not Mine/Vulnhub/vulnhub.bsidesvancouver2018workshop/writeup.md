...
![writeup.overview.machinescli](Box%20Write-ups/vulnhub.bsidesvancouver2018workshop/machinescli.png)

### Killchain
Here's the killchain (`enumeration` → `exploitation` → `privilege escalation`) for this machine:

![writeup.overview.killchain](Box%20Write-ups/vulnhub.bsidesvancouver2018workshop/killchain.png)
...
![writeup.enumeration.steps.2.1](Box%20Write-ups/vulnhub.bsidesvancouver2018workshop/openports.png)  
...
![writeup.enumeration.steps.3.1](Box%20Write-ups/vulnhub.bsidesvancouver2018workshop/screenshot03.png)  
...
![writeup.enumeration.steps.4.1](Box%20Write-ups/vulnhub.bsidesvancouver2018workshop/screenshot01.png)  
...
![writeup.exploitation.steps.1.1](Box%20Write-ups/vulnhub.bsidesvancouver2018workshop/screenshot02.png)  
...
![writeup.exploitation.steps.2.1](Box%20Write-ups/vulnhub.bsidesvancouver2018workshop/screenshot04.png)  

3\. (method #1) While testing, an unknown response is sent for username, password combo of `john` and `enigma`:  

![writeup.exploitation.steps.3.1](Box%20Write-ups/vulnhub.bsidesvancouver2018workshop/screenshot05.png)  

4\. (method #1) We test these credentials manually and are successfully logged in:  

![writeup.exploitation.steps.4.1](Box%20Write-ups/vulnhub.bsidesvancouver2018workshop/screenshot06.png)  

5\. (method #1) We edit the `footer.php` theme file to gain command execution:  

![writeup.exploitation.steps.5.1](Box%20Write-ups/vulnhub.bsidesvancouver2018workshop/screenshot07.png)  
...
![writeup.exploitation.steps.6.1](Box%20Write-ups/vulnhub.bsidesvancouver2018workshop/screenshot08.png)  
...
![writeup.exploitation.steps.7.1](Box%20Write-ups/vulnhub.bsidesvancouver2018workshop/screenshot10.png)  
...
![writeup.exploitation.steps.8.1](Box%20Write-ups/vulnhub.bsidesvancouver2018workshop/screenshot12.png)  

9\. (method #2) We can ssh as user `anne` and gain interactive access:  

![writeup.exploitation.steps.9.1](Box%20Write-ups/vulnhub.bsidesvancouver2018workshop/screenshot13.png)  
...
![writeup.privesc.steps.1.1](Box%20Write-ups/vulnhub.bsidesvancouver2018workshop/screenshot15.png)  
...
![writeup.privesc.steps.3.1](Box%20Write-ups/vulnhub.bsidesvancouver2018workshop/screenshot16.png)  
...
![writeup.privesc.steps.5.1](Box%20Write-ups/vulnhub.bsidesvancouver2018workshop/screenshot17.png)  
...
![writeup.privesc.steps.6.1](Box%20Write-ups/vulnhub.bsidesvancouver2018workshop/screenshot14.png)  
