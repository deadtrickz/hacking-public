...
![writeup.overview.machinescli](Box%20Write-ups/vulnhub.linsecurity1/machinescli.png)

### Killchain
Here's the killchain (`enumeration` → `exploitation` → `privilege escalation`) for this machine:

![writeup.overview.killchain](Box%20Write-ups/vulnhub.linsecurity1/killchain.png)
...
![writeup.enumeration.steps.2.1](Box%20Write-ups/vulnhub.linsecurity1/openports.png)  
...
![writeup.enumeration.steps.3.1](Box%20Write-ups/vulnhub.linsecurity1/screenshot01.png)  
...
![writeup.exploitation.steps.1.1](Box%20Write-ups/vulnhub.linsecurity1/screenshot02.png)  

![writeup.exploitation.steps.1.2](Box%20Write-ups/vulnhub.linsecurity1/screenshot03.png)  

![writeup.exploitation.steps.1.3](Box%20Write-ups/vulnhub.linsecurity1/screenshot04.png)  
...
![writeup.exploitation.steps.2.1](Box%20Write-ups/vulnhub.linsecurity1/screenshot05.png)  
...
![writeup.exploitation.steps.3.1](Box%20Write-ups/vulnhub.linsecurity1/screenshot06.png)  
...
![writeup.privesc.steps.1.1](Box%20Write-ups/vulnhub.linsecurity1/screenshot07.png)  

![writeup.privesc.steps.1.2](Box%20Write-ups/vulnhub.linsecurity1/screenshot08.png)  
...
![writeup.privesc.steps.2.1](Box%20Write-ups/vulnhub.linsecurity1/screenshot09.png)  

![writeup.privesc.steps.2.2](Box%20Write-ups/vulnhub.linsecurity1/screenshot10.png)  

![writeup.privesc.steps.2.3](Box%20Write-ups/vulnhub.linsecurity1/screenshot11.png)  
...
![writeup.privesc.steps.3.1](Box%20Write-ups/vulnhub.linsecurity1/screenshot12.png)  

![writeup.privesc.steps.3.2](Box%20Write-ups/vulnhub.linsecurity1/screenshot13.png)  
